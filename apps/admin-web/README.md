...
참가자가 올린 사진은 **5분이면 알아서 사라집니다.** 그래서 이 화면의 가치는 딱 하나,
**"지금 당장 내린다"** 입니다.

부적절한 사진이 스크린에 떠 있는데 5분을 기다릴 수는 없습니다. 반대로 말하면,
급하지 않은 것은 굳이 손대지 않아도 됩니다. 기다리면 사라집니다.
...
정상입니다. 최근 5분 동안 아무도 올리지 않았다는 뜻입니다.
...
**목록은 Realtime 구독으로 유지합니다.** 전시물이 5분이면 스스로 사라지기 때문에,
한 번 불러온 목록을 그대로 두면 이미 없는 사진에 삭제를 시도하게 됩니다.
