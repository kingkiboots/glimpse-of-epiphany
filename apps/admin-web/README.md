...
참가자가 올린 사진은 **저절로 사라지지 않습니다.** 한 번 올라오면 누군가 내리기 전까지
계속 화면에 남습니다. **이 화면이 유일한 삭제 수단입니다.**

부적절한 사진이 스크린에 떠 있으면 여기서 내려야 하고, 그러지 않으면 계속 떠 있습니다.
행사가 끝난 뒤 정리하는 것도 이 화면에서 합니다.
...
아직 아무도 올리지 않았거나, 올라온 사진을 모두 지웠다는 뜻입니다.
...
- [ ] 사진은 저절로 사라지지 않는다는 것을 기억하기 — 내려야 내려갑니다
- [ ] 행사가 끝나면 남은 사진 정리하기 (참가자 개인 사진입니다)
...
**목록은 Realtime 구독으로 유지합니다.** 참가자가 올리는 사진이 계속 들어오고 다른 운영자가
지우기도 하므로, 한 번 불러온 목록을 그대로 두면 이미 없는 사진에 삭제를 시도하게 됩니다.
